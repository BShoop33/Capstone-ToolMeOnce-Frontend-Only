...
import { LendMessagesCard } from "./LendMessagesCard"
import { useHistory } from "react-router-dom"

export const LendMessagesList = () => {
    const { lendMessage, getLendMessages } = useContext(LendMessagesContext)
        ...
        <>
            <div className="Reply">
                ...
                <div className="ReplyAddToolButtonsContainer">
                    <button className="ReplySendButton" onClick={() => { history.push("/lend") }} type="button">Send</button>
                    <button className="ReplyCancelButton" onClick={() => { history.push("/lend") }} type="button">Cancel</button>
                </div>
            </div>
        </>
    )
